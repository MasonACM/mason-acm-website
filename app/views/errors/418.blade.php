...
<html>
    ...
    <div class="jumbotron visible-md visible-lg">
		<div class="container">
			<h1 style="text-align: center;">It's Tea Time!</h1>
		</div>
	</div>
	...
	<div class="row">
		...
		<ul style="text-align: center;">
			<h1>Sorry, it seems that Nathan's dinosaurs are teapots.</h1>
			<img src="http://i559.photobucket.com/albums/ss36/CrabOfDoomLJ/random_bin/thrift_horror/thrifthorror_2009_1005_03.jpg">
